...
export const MARKET_PHASES: { [key: string]: MarketPhase } = {
  BULL_RUN: {
    ...
    theme: i18n.t('marketPhaseTheme.euphoria'),
    minTime: 0,
    maxTime: 60,
    minScore: 0,
    maxScore: 500,
  ...
  CORRECTION: {
    ...
    theme: i18n.t('marketPhaseTheme.realitySetsIn'),
    minTime: 60,
    maxTime: 120,
    minScore: 500,
    maxScore: 1500,
  ...
  BEAR_TRAP: {
    ...
    theme: i18n.t('marketPhaseTheme.panic'),
    minTime: 120,
    maxTime: 180,
    minScore: 1500,
    maxScore: 3000,
  ...
  SIDEWAYS: {
    ...
    theme: i18n.t('marketPhaseTheme.marketBreathes'),
    minTime: 180,
    maxTime: 240,
    minScore: 3000,
    maxScore: 4000,
  ...
  VALOR_COMEBACK: {
    ...
    theme: i18n.t('marketPhaseTheme.heroic'),
    minTime: 240,
    maxTime: 600,
    minScore: 4000,
    maxScore: 999999,
  ...
  ENDLESS_WAGMI: {
    ...
    theme: i18n.t('marketPhaseTheme.chaos'),
    minTime: 600,
    maxTime: 999999,
    minScore: 999999,
    maxScore: 9999999,
